	...
	<div class="container">
		...
		<section class="container" ng-app="cartApp">
			<div ng-controller="cartCtrl" ng-init="initCartId('${cartId}')">
				<a class="btn btn-warning pull-left" ng-click="clearCart()" style="margin-bottom:10px; color:white;">
				...
				<table class="table table-hover">
					...
					<tr ng-repeat="item in cart.cartItems">
						...
						<td><a class="btn btn-danger" ng-click="updateQuantity(item.product.id, 1)" style="color:white">
